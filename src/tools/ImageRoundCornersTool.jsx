  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-violet-500/10 via-purple-500/10 to-violet-500/10 border border-violet-500/20 rounded-2xl p-6 md:p-8">
        ...
        <div className="flex items-center gap-3 text-xs text-violet-400 font-medium">
      ...
      {!image ? (
        ...
        <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-white p-6 rounded-xl border border-white/5 items-center">
            <div>
            ...
            <div>
              <label className="flex items-center gap-3 cursor-pointer text-xs text-[#1f2532] mt-4">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center justify-center">
            <div className="relative bg-white border border-[#e6e9ef] rounded-xl overflow-hidden max-h-72 flex items-center justify-center p-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-6 border-t border-[#e6e9ef]">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto py-3 px-6 rounded-xl bg-violet-500 text-black font-bold hover:bg-violet-400 transition-all flex items-center justify-center gap-3 shadow-lg shadow-violet-500/20"
            >
              {loading ? (
                <>
            ...
            {processedUrl && (
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <NativeShareButton 
                  ...
                  fileName={`rounded-screenshot-${image.name.replace(/\\.[^/.]+$/, '')}.png`} 
                  mimeType="image/png" 
                />
              </div>
            )}
