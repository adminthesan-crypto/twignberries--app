        ...
        {images.length > 0 && (
          <div className="flex justify-end pt-4 border-t border-[#e6e9ef]">
            <button
              ...
              disabled={loading}
              className="py-3 px-6 rounded-xl bg-amber-500 text-black font-bold hover:bg-amber-400 transition-all flex items-center gap-3 shadow-lg shadow-amber-500/20"
            >
              {loading ? (
                <>
