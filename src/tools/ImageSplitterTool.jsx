    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {!image ? (
        <label className="border-2 border-dashed border-[#d0d4e4] hover:border-indigo-500/50 rounded-2xl p-12 text-center cursor-pointer block transition-all bg-[#f6f8fa] hover:bg-white">
          ...
          <p className="text-[#1f2532] font-medium mb-3">Drop photo to slice into a grid here</p>
        ...
        <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[11px] text-[#9ca3af] block mb-3">Columns ({cols})</label>
            ...
            <div>
              <label className="text-[11px] text-[#9ca3af] block mb-3">Rows ({rows})</label>
