    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {!image ? (
        ...
        <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 bg-white p-6 rounded-xl border border-white/5">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-2">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto py-3 px-6 rounded-xl bg-purple-500 text-black font-bold hover:bg-purple-400 transition-all flex items-center justify-center gap-3 shadow-lg shadow-purple-500/20"
            >
              {loading ? (
                <>
            ...
            {watermarkedUrl && (
              <div className="flex gap-3">
                ...
                <NativeShareButton 
                  ...
                  fileName={`watermarked-${image.name}`} 
                  mimeType="image/png" 
                />
              </div>
            )}
