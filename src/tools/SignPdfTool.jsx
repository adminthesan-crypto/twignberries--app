    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-blue-500/10 border border-blue-500/20 rounded-2xl p-6 md:p-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-2xl font-heading font-bold text-white">Sign PDF (Electronic Signatures)</h1>
            <p className="text-sm text-[#9ca3af]">Sign PDF documents electronically with cursive ink styling and digital timestamps.</p>
          </div>
        </div>
      ...
      {!file ? (
        <label className="border-2 border-dashed border-white/20 hover:border-blue-500/50 rounded-2xl p-12 text-center cursor-pointer block transition-all bg-white/[0.02] hover:bg-white/[0.04]">
          ...
          <p className="text-white font-medium mb-1">Drop PDF file to sign here or click to select</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/50 border border-white/10 rounded-xl py-2.5 px-4 text-white text-sm font-serif italic focus:outline-none focus:border-blue-500"
              />
            </div>
            <div>
              <label className="text-xs font-semibold text-[#9ca3af] uppercase tracking-wider block mb-2">
              ...
              <input
                ...
                className="w-full bg-black/50 border border-white/10 rounded-xl py-2.5 px-4 text-white text-sm focus:outline-none focus:border-blue-500"
              />
            </div>
            <div>
              <label className="text-xs font-semibold text-[#9ca3af] uppercase tracking-wider block mb-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="X"
                  className="w-1/2 bg-black/50 border border-white/10 rounded-xl py-2.5 px-3 text-white text-sm focus:outline-none focus:border-blue-500"
                />
                <input
                  type="number"
                  value={yPos}
