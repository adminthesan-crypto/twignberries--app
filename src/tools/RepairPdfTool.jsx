    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {!file ? (
        ...
        <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-6">
          ...
          {repairLog.length > 0 && (
            <div className="bg-black/60 border border-[#e6e9ef] rounded-xl p-6 font-mono text-xs space-y-1 text-[#9ca3af]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto py-3 px-6 rounded-xl bg-amber-500 text-black font-semibold hover:bg-amber-400 transition-all flex items-center justify-center gap-3 shadow-lg shadow-amber-500/20"
            >
              {loading ? (
                <>
            ...
            {repairedPdf && (
              <div className="flex gap-4 w-full sm:w-auto">
                ...
                <NativeShareButton fileUrl={URL.createObjectURL(repairedPdf)} fileName={`repaired-${file.name}`} mimeType="application/pdf" />
              </div>
            )}
          </div>
        </div>
