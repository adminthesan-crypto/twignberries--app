    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-purple-500/10 via-indigo-500/10 to-purple-500/10 border border-purple-500/20 rounded-2xl p-6 md:p-8">
        <div className="flex items-center gap-6 mb-3">
          ...
          <div>
            <h1 className="text-2xl font-heading font-bold text-[#1f2532]">PDF to PDF/A (Archival Standard)</h1>
            <p className="text-sm text-[#676879]">Convert standard PDFs into ISO-standardized PDF/A-1b files for long-term archiving and legal compliance.</p>
          </div>
        </div>
        ...
        <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto py-3 px-6 rounded-xl bg-purple-500 text-white font-semibold hover:bg-purple-600 transition-all flex items-center justify-center gap-3 shadow-lg shadow-purple-500/20"
            >
              {loading ? (
                <>
