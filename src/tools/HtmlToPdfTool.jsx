  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-[#f6f8fa] border border-[#e6e9ef] rounded-2xl p-6 space-y-6">
        <div className="flex gap-6 border-b border-[#e6e9ef] pb-4">
          <button
            onClick={() => { setMode('html'); setPdfBlob(null); }}
            className={`px-4 py-2 rounded-xl text-xs font-semibold flex items-center gap-3 transition-all ${
              mode === 'html'
        ...
        {mode === 'html' ? (
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full bg-white border border-[#e6e9ef] rounded-xl p-6 text-[#1f2532] font-mono text-sm focus:outline-none focus:border-orange-500"
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-[#e6e9ef] rounded-xl p-6 text-[#1f2532] text-sm focus:outline-none focus:border-orange-500"
