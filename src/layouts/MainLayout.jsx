        ...
        <div style={{ maxWidth: 1040, margin: '0 auto', width: '100%' }}>
          <div className="pb-footer-grid">
            ...
            <div className="pb-footer-brand">
              <h3 style={{ fontFamily: "Impact, 'Arial Black', sans-serif", fontWeight: 900, fontSize: 28, letterSpacing: '-0.04em', fontStyle: 'italic', textTransform: 'uppercase', WebkitTextStroke: '0.5px #111', transform: 'skewX(-5deg)', display: 'inline-block', color: '#111' }}>PAHRULI<span style={{ color: '#ff3d8b' }}>.</span></h3>
