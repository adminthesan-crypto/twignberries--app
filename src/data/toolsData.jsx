...
const TOOLS = [
  ...
  },
  {
    ...
    useCases: ['indian-freelancer-gst', 'consulting-services', 'contractor', 'international-client'],
  },
  {
    id: 'pdf-markdown',
    seo: {
  ...
  },
  {
    ...
    useCases: ['aadhaar-and-pan', 'resume-and-cover-letter', 'scanned-documents', 'bank-statements', 'ilovepdf-free-alternative-no-limit', 'smallpdf-daily-limit-bypass', 'offline-no-upload', 'safe-for-bank-statements'],
  },
  {
    id: 'split-pdf',
    seo: {
    ...
    useCases: ['extract-one-page', 'remove-blank-pages', 'split-by-size'],
  },
  {
    id: 'image-to-pdf',
    seo: {
  ...
  // ─── PDF Suite Expansion (20 New Tools) ───
  {
    ...
    useCases: ['under-200kb-ssc', 'under-100kb-upsc', 'under-10mb-college-assignment', 'for-email-attachment', 'fix-file-size-exceeds-limit', 'whatsapp-media-file-larger-than-100mb', 'iphone-browser-no-app', 'android-free-no-download'],
  },
  {
    id: 'word-to-pdf',
    seo: {
  ...
  },
  {
    ...
    useCases: ['editable-resume', 'legal-contract', 'scanned-document'],
  },
  {
    id: 'excel-to-pdf',
    seo: {
